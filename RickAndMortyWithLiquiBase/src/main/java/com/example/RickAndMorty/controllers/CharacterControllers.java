...
public class CharacterControllers {
    ...
    public String updateCharacter(@RequestBody RequestDTOStructure updatedDto, @PathVariable Integer id ){
        crudServices.updateCharacter(updatedDto , id);
        return "entity with "+updatedDto.getId()+" has been updated";
    }
